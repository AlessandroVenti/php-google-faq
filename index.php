...
<body>
     ...
     <div>          
          <?php
               ...
               $googlePrivacy = [
                    ...
                    [
                         ...
                         "paragraph" => ["<p> Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose: </p>",
                                        "<ol> <li> La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti: <ul> <li> Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera. </li> <li> Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li> </ul></li> <li> La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali. </ol>",
                    ...
                    [
                         "title" => "<h1> Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google? </h1>",
               ...
               foreach ($googlePrivacy as $value) {
                    echo $value['title'];
                    foreach($value['paragraph'] as $value2 ) {
                         echo $value2;
                    }
               }
          ?>
